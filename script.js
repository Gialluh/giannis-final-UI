...
async function loadConfig() {
    try {
        ...
        SIGNPOST_API_URL = config.SIGNPOST_API_URL;
        ...
        // Fallback to local config if available (for local development with config.js)
...
// Initialize app after configuration is loaded
loadConfig().then(() => {
    if (!configLoaded) {
